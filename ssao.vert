...
out vec4 out_EyeCoord; // vertex position (camera/eye coordinates)
...
void main() 
{
	...
	out_Normal = normalize(transpose(inverse(mat3(actualModelView)))*in_Normal.xyz);
	...
	out_EyeCoord = actualModelView * vec4(in_Position.xyz, 1);
}
